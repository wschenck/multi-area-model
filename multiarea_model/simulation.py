...
class Simulation:
    ...
    def create_recording_devices(self):
        ...
        try:
            ...
            if status_dict['record_to'] == 'ascii':
                status_dict['record_to'] = ['file']
                status_dict['withtime'] = True
            nest.SetStatus(self.spike_detector, status_dict)
...
class Area:
    ...
    def create_populations(self):
        ...
        for pop in self.populations:
            ...
            if gid.__class__.__name__ == 'NodeCollection':
                # Store GIDCollection of each populatio
                self.gids[pop] = gid
            else:
    ...
    def connect_devices(self):
        if self.name in self.simulation.params['recording_dict']['areas_recorded']:
            for pop in self.populations:
                ...
                # statistics
                if self.gids[pop].__class__.__name__ == 'NodeCollection':
...
def connect(simulation,
    ...
    for target in target_area.populations:
        for source in source_area.populations:
            ...
            if source_area.gids[source].__class__.__name__ == 'NodeCollection':
